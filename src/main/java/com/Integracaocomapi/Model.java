...
public class Model{
    private static String URLBase = "http://www.poatransporte.com.br/php/facades/process.php";
    ...
    public String doRequest(String path){
        ...
        try {
            HttpGet httpGet = new HttpGet(Model.URLBase + path) ;
            ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
                ...
                public String handleResponse(
                    ...
                    if (status >= 200 && status < 300) {
                        ...
                        throw new ClientProtocolException("resposta não esperada: Status code " + status);
                    }
                }
            };
